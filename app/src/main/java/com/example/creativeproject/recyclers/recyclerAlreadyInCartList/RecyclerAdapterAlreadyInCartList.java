...
public class RecyclerAdapterAlreadyInCartList extends RecyclerView.Adapter<RecyclerAdapterAlreadyInCartList.MyViewHolder> {

    private List<Product> listOfProducts;
    TextView isCartEmptyText;
    ...
    public RecyclerAdapterAlreadyInCartList(List<Product> productList, TextView isCartEmptyText) {
        this.listOfProducts = productList;
        this.isCartEmptyText = isCartEmptyText;
    }
    @Override
    public RecyclerAdapterAlreadyInCartList.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (listOfProducts.size() == 1) {
            isCartEmptyText.setText("Уже в корзине:");
        }
    }
    @Override
    ...
    public void onItemDismiss(int position) {
        ...
        if (listOfProducts.isEmpty()) {
            isCartEmptyText.setText("Корзина пуста!");
        }
    }
