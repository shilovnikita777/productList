package com.example.creativeproject.recyclers.recyclerListInHistory;
...
public class RecyclerAdapterListInHistory extends RecyclerView.Adapter<RecyclerAdapterListInHistory.MyViewHolder> {
    ...
    public RecyclerAdapterListInHistory(List<Product> productList) {
        this.listOfProducts = productList;
    }
    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cart_item_for_dialog, parent, false);
